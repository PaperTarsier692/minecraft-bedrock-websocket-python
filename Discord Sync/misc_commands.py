...
def yes_no(text, color=''):
    ...
    color = color.replace('red', "\033[91m").replace('yellow', "\033[93m").replace(
        'green', "\033[92m").replace('blue', "\033[94m")
...
def print_color(text: str):
    ...
    text = text.replace('//red// ', "\033[91m").replace('//yellow// ', "\033[93m").replace(
        '//green// ', "\033[92m").replace('//blue// ', "\033[94m")
    print(text + "\033[0m")
